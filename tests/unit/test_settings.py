...
class TestCase(unittest.TestCase):
    ...
    def test_default_local_variables(self):
        ...
        self.assertEqual(settings.NOTIFY_BUS, False)
        ...
        self.assertEqual(settings.TRIPLESTORE_CONFIG_FILEPATH, '/Users/sestari/Documents/brainiak_api/src/brainiak/triplestore.ini')
